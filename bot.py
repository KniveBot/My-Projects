...
# Google ( Все о таблице )
gscope = ['https://spreadsheets.google.com/feeds', 'https://www.googleapis.com/auth/drive']
gcredentials = 'creds.json'
gdocument = 'BioDent List'

# Токен Бота
bot = telebot.TeleBot('1201193969:AAEMPailP_42ma7el7eCs8mbXP3PHxSnag8');
...
keyboardDname.row('Литвиненко Ирина Владимировна')
keyboardDname.row('Морозова Виктория Геннадьевна')
keyboardDname.row('Ахметова Айдана Ермухановна')
...
def get_usluga(message):
    global usluga;
    usluga = message.text;
    bot.send_message(message.from_user.id, 'Введите дату и время(01.01.10 11.00)');
